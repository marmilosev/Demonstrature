...
public class Izbornik extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnUnosMuskarac = new javax.swing.JButton();
        btnUnosSestra = new javax.swing.JButton();
        btnCrudSestra = new javax.swing.JButton();
        ...
        btnUnosMuskarac.setText("3.3.");
        btnUnosMuskarac.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUnosMuskaracActionPerformed(evt);
            }
        });

        btnUnosSestra.setText("3.4.");
        btnUnosSestra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUnosSestraActionPerformed(evt);
            }
        });

        btnCrudSestra.setText("3.7.");
        btnCrudSestra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCrudSestraActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnUnosSestra)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnUnosCura)
                            .addComponent(btnUnosZarucnica)
                            .addComponent(btnUnosMuskarac))
                        .addGap(245, 245, 245)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnCrudSestra)
...
//            z.setCura(oc.read().get(0));
    ...
    private void btnCrudSestraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrudSestraActionPerformed
        // TODO add your handling code here:
        new ProzorSestra().setVisible(true);
    }//GEN-LAST:event_btnCrudSestraActionPerformed

    private void btnUnosMuskaracActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUnosMuskaracActionPerformed
        // TODO add your handling code here:
         ObradaMuskarac om = new ObradaMuskarac();
        Muskarac m; 
        for(int i = 0; i<139; i++){
            m = new Muskarac();
            m.setBojaOciju(faker.color().name());
            m.setNarukvica(faker.number().randomDigit());
            m.setIndiferentno(faker.bool().bool());
            om.setEntitet(m);
    ...
    }//GEN-LAST:event_btnUnosMuskaracActionPerformed

    private void btnUnosSestraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUnosSestraActionPerformed
        // TODO add your handling code here:
    ObradaSestra os = new ObradaSestra();
    ObradaMuskarac om = new ObradaMuskarac();
    List<Muskarac> muskarci = om.read();
    
    for (int i = 0; i < 902; i++) {
        Sestra s = new Sestra(); // Stvaranje nove instance unutar petlje
        
        List<Muskarac> kno = new ArrayList<>();
        kno.add(muskarci.get(faker.random().nextInt(19, 41)));
        kno.add(muskarci.get(faker.random().nextInt(19, 41)));
        
        s.setMuskarci(kno);
        s.setBojaOciju(faker.color().name());
        s.setDatetime(faker.date().birthday());
        s.setKuna(faker.number().randomDouble(NORMAL, 12, 143));
        s.setNausnica(faker.random().nextInt(1));
        s.setSuknja(faker.chuckNorris().fact());
        s.setTreciPuta(faker.date().birthday());
    ...
    }//GEN-LAST:event_btnUnosSestraActionPerformed
    ...
    private javax.swing.JButton btnCrudSestra;
    private javax.swing.JButton btnCrudZarucnica;
    private javax.swing.JButton btnUnosCura;
    private javax.swing.JButton btnUnosMuskarac;
    private javax.swing.JButton btnUnosSestra;
